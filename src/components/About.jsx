...
export default function About() {
  return (
    <section id="about" className="bg-[var(--paper)] print-soft px-6 py-16">
      ...
      <div className="relative max-w-6xl mx-auto bg-white border border-[var(--rule)] shadow-[0_18px_50px_rgba(0,0,0,0.10)] overflow-hidden">
        ...
        <div className="hidden md:block absolute right-8 bottom-8 pointer-events-none opacity-90">
          <img src={Leaf} alt="Decorative art" className="w-32 float-slow-alt scale-x-[-1]" />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-8">
              <div className="columns-1 md:columns-2 gap-10 font-serif text-[var(--ink)] leading-relaxed">
                <p className="mb-4">
                  I’m Tarus — a web developer, UI/UX designer, and artist who
                  finds beauty in structure, simplicity, and creativity. I enjoy
                  building interfaces that feel clear and calm, but also human.
                </p>

                <p className="mb-4">
                  My work blends clean code with expressive visuals. Whether I’m
                  designing a user flow, prototyping in Figma, or building a
                  React component, I care deeply about hierarchy, spacing, and
                  the emotional tone of a product.
                </p>
                ...
                <p className="mb-4">
                  ...
                  to feel editorial, timeless, and crafted — the same way I aim
                  to craft the experiences I design.
                </p>
              </div>
